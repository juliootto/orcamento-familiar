...
public class TipoOrcamento {
	...
	public TipoOrcamento(String descricao) {
		...
		this.idTipoOrcamento = (long) em.createQuery(selectionQuery).setParameter("descricao", descricao).getSingleResult(); //This should be placed in a try/catch block to handle org.hibernate.NonUniqueResultException
	}
